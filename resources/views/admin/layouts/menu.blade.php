            ...
            <ul class="menu-inner py-1">
              ...
              <li class="menu-item">
                <a href="{{ route('admin.category.index') }}" class="menu-link">
                  ...
                  <div data-i18n="User interface">Danh mục dịch vụ</div>
                </a>
              </li>
              ...
              <li class="menu-item">
                <a href="{{ route('admin.coupon.index') }}" class="menu-link">
                  ...
                  <div data-i18n="User interface">Mã giảm giá</div>
                </a>
              </li>
              ...
              <li class="menu-item">
                <a href="javascript:void(0)" class="menu-link menu-toggle">
                  ...
                  <div data-i18n="User interface">Bình luận/đánh giá</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{ route('admin.account-giupviec') }}" class="menu-link">
                      <div data-i18n="Accordion">Bài viết</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.account-users.index') }}" class="menu-link">
                      <div data-i18n="Accordion">Sản phẩm</div>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{ route('admin.account-giupviec') }}" class="menu-link">
                      <div data-i18n="Accordion">Người giúp việc</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.account-users.index') }}" class="menu-link">
                      <div data-i18n="Accordion">Khách hàng</div>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="menu-item">
                <a href="{{ route('admin.logout') }}" class="menu-link">
                  ...
                  <div data-i18n="User interface">Đăng xuất</div>
                </a>
              </li>
            </ul>
          </aside>
