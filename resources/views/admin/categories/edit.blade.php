...
<div class="col-xxl">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">Cập nhật danh mục dịch vụ</h5>
      ...
      <div class="card-body ">
        <form action="{{ route('admin.category.update',$category->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="basic-default-name" name="category_name" placeholder="category name" value="{{ $category->category_name }}" />
              @error('category_name')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="basic-default-name" name="category_slug" placeholder="category slug" value="{{ $category->category_slug }}" />
              @error('category_slug')
                <span style="color: red">{{ $message }}</span>
              @enderror
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" data-role="tagsinput" id="basic-default-name" name="category_tags" value="{{ $category->category_tags }}" />
              @error('category_slug')
                <span style="color: red">{{ $message }}</span>
              @enderror
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <input type="text" id="basic-default-email" class="form-control" aria-describedby="basic-default-email2" name="category_des" value="{{ $category->category_des }}" />
              </div>
              @error('category_des')
              <span style="color: red">{{ $message }}</span>
            @enderror
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea name="category_content" id="blog_content" class="form-control" placeholder="Hi, Do you have a moment to talk Joe?"
                aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2" >{{ $category->category_content }}</textarea>
            ...
            <div class="col-sm-10">
                <select class="form-select" id="inputGroupSelect01" name="category_level">
                    ...
                    @foreach ($list_Category as $item => $val )
                        <option value="{{ $val->id }}" @if ($val->id == $category->category_id)
                            selected
