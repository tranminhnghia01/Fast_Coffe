...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tài khoản/</span> cá nhân</h4>

    <div class="row">
      <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> Tài khoản cá nhân</a>
          </li >
          <li class="nav-item">
        ...
        <div class="card mb-4">
            ...
            @if (session('msg'))
              <div class="alert alert-{{session('style')}}">
                {{ session('msg') }}
				    ...
				    @endif
            <form method="post" enctype="multipart/form-data"  action="{{ route('admin.uploadfile') }}">
              @csrf
          ...
          <hr class="my-0" />
          <div class="card-body">
            <form id="formAccountSettings" method="POST" action="{{ route('admin.update.account',$user->id) }}">
              @csrf
              <div class="row">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <input class="form-control" type="password" id="passord" name="passord" value="User password" placeholder="password" />
                </div>
              ...
              <div class="mt-2">
                ...
                <button type="reset" class="btn btn-outline-secondary">kết thúc</button>
              </div>
            </form>
          </div>
          <!-- /Account -->
